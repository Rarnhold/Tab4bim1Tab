...
Tela principal em Swing. Usar JMenuBar para as funcionalidades. Abrir telas de cadastro e filtros de relatórios em abas no centro da 

tela principal. O sistema deve solicitar usuário e senha ao iniciar. Os relatórios devem ser exportados em PDF e abrir automaticamente com o visualizador padrão de PDF do sistema operacional.

--As telas de cadastro e de vendas devem possuir um JTable na parte inferior contendo os registros já gravados, 

--ao clicar (duplo) no item da JTable ele deve ser carregado para edição.
